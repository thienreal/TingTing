...
export class InitTables1788191550220 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_vouchers_status_enum" AS ENUM('ACTIVE', 'USED', 'EXPIRED')`);
        await queryRunner.query(`CREATE TABLE "user_vouchers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "voucher_id" uuid NOT NULL, "status" "public"."user_vouchers_status_enum" NOT NULL DEFAULT 'ACTIVE', "redeemed_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_66534a148ba312dd88e48ee6072" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."transactions_type_enum" AS ENUM('EARN', 'REDEEM')`);
        ...
        await queryRunner.query(`ALTER TABLE "user_vouchers" ADD CONSTRAINT "FK_907ebb0f49f4650c8d68094183e" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_vouchers" ADD CONSTRAINT "FK_d9647d12bc95a815a68ae9b933c" FOREIGN KEY ("voucher_id") REFERENCES "vouchers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "vouchers" ADD CONSTRAINT "FK_49fa70c04f6c7dfa458b7b29b19" FOREIGN KEY ("merchant_id") REFERENCES "merchants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "vouchers" DROP CONSTRAINT "FK_49fa70c04f6c7dfa458b7b29b19"`);
        await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "FK_e80829a78860eadca0d60c8e21f"`);
        await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "FK_e9acc6efa76de013e8c1553ed2b"`);
        await queryRunner.query(`ALTER TABLE "user_vouchers" DROP CONSTRAINT "FK_d9647d12bc95a815a68ae9b933c"`);
        await queryRunner.query(`ALTER TABLE "user_vouchers" DROP CONSTRAINT "FK_907ebb0f49f4650c8d68094183e"`);
